...
// Parameters ==========================================================
work_dir='C:\MyDrive\Work\CO_junc\md_cw' // upper of td.xxxxxxxx
h_par=0.2 // h parameter used in Octopus
ref_dir='gs'       // a number or 'gs'
start_dir=0        // start dir
end_dir=30000//60000      // end dir
...
// reshape ref_data to [z,y,x] ordering
ref_data=matrix(ref_data,data_grid(3),data_grid(2),data_grid(1));
...
for n=1:tot_run
    ...
    read_data=matrix(read_data,data_grid(3),data_grid(2),data_grid(1));
...
figure(1)
plot(tot_charge(:,1)*0.658,tot_charge(:,5));
...
title('charge fluctation','font_size',4)
